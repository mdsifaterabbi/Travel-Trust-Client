...
const Footer1 = () => {
  ...
  return (
    <>
      <div className="flex sm:flex-row md:flex-row lg:flex-row xl:flex-row flex-wrap">
        <div className="sm:basis-1/2 md:basis-1/2 lg:basis-1/2 xl:basis-1/2 bg-[#003f9f]">
          <div className="my-[30px] text-left sm:w-[87%] md:w-[95%] lg:w-[90%] xl:w-[70%] mx-auto">
            <p className="text-white font-bold sm:text-[14px] md:text-[16px] lg:text-[18px] xl:text-[20px]">Travel Trust Pro</p>
            <p className="text-white font-bold sm:text-[14px] md:text-[16px] lg:text-[18px] xl:text-[18px]">
              Passports. Visas. Legalizations. Done.{" "}
            </p>
          </div>
        </div>
        <div className="sm:basis-1/2 md:basis-1/2 lg:basis-1/2 xl:basis-1/2 bg-[#003f9f] relative top-0 left-0">
          <div className="sm:w-[98%] md:w-[90%] lg:w-[90%] xl:w-[80%] bg-[#ffffff] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] py-[10px] rounded-md border">
